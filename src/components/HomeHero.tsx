    ...
    <section className="px-4 pt-5 md:px-8">
      <div className="relative min-h-[500px] overflow-hidden rounded-3xl border border-yellow-500/30 bg-slate-950 shadow-2xl md:min-h-[650px]">
        ...
        <div className="relative z-10 flex min-h-[500px] items-end justify-center px-5 pb-10 md:min-h-[650px] md:pb-14">
          {showPanel && (
            <div className="relative w-full max-w-4xl rounded-3xl border border-white/10 bg-slate-950/80 p-6 text-center shadow-2xl backdrop-blur-md md:p-9">
              <button
                type="button"
                onClick={() => setShowPanel(false)}
                className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-black/60 text-xl font-black text-white transition hover:border-red-400 hover:bg-red-500"
                aria-label="Kapat"
                title="Kapat"
              >
                ×
              ...
              <p className="mx-auto mt-4 max-w-3xl text-sm leading-7 text-slate-300 md:text-base">
                ...
                aradigin urune hizla ulas ve guncel fiyatlari kolayca
                karsilastir.
              </p>
              ...
              <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                <button
                  ...
                  className="rounded-xl bg-yellow-400 px-8 py-4 font-bold text-black transition hover:bg-yellow-500"
                >
                  Ilanlara Goz At
                </button>
                ...
                <button
                  ...
                  className="rounded-xl bg-emerald-500 px-8 py-4 font-bold text-white transition hover:bg-emerald-600"
                >
                  Ilan Ver
                </button>
              </div>
